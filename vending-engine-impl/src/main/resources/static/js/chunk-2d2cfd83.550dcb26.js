    ...
    "04a6": function (t, e, s) {
        ...
        var a = function () {
            ...
            return s("div", {staticClass: "order"}, [0 === t.stepStates[4] ? s("div", [s("div", {staticClass: "order__header"}, [s("router-link", {
                ...
                attrs: {paramPaymentMethod: t.paymentMethod},
                on: {changePaymentMethod: t.changePaymentMethod, setThirdStep: t.setThirdStep}
            })], 1) : t._e()], 1), s("div", {
                staticClass: "order__box",
                ...
                attrs: {
                    ...
                    sum: t.product.price
                }, on: {setFirstStep: t.setFirstStep}
            })], 1) : t._e()], 1), s("div", {
                staticClass: "order__box",
            ...
            }), 1 === t.paymentMethod ? s("div", {staticClass: "cash-back"}, [t._v(" Ваша сдача: " + t._s(t.getCashBack()) + " ₽ ")]) : t._e(), s("h1", [t._v("Спасибо за покупку. Заберите товар в нижнем окне")]), s("button", {
            ...
            name: "Order", created: function () {
                ...
                getBoxClass: function (t) {
                    ...
                    this.paymentMethod = 0, this.stepStates = {1: 1, 2: 0, 3: 0, 4: 0}
                ...
                }, returnOfCashback: function () {
                    var t = this.getCashBack();
                    if (t) {
                        var e, s;
                        try {
                            this.dev_mode ? (e = "dispense".concat(t, ".json"), s = i.a.get(e)) : (e = "dispense", s = i.a.post(e, {dispenseValue: t}))
                        } catch (a) {
                            console.warn(a.message)
                        }
                        s.then((function (t) {
                            console.log("Response for dispense", t.data)
                        }))
                    }
                }
            }, computed: Object(n["a"])({}, Object(o["b"])(["product", "incomeSum"]))
        }, p = d, h = (s("04a6"), s("2877")), u = Object(h["a"])(p, a, r, !1, null, null, null);
        e["default"] = u.exports
    }
}]);
//# sourceMappingURL=chunk-2d2cfd83.550dcb26.js.map